...
void drawRectDMA(int row, int col, int width, int height, volatile u16 color) {
  ...
  for(int i = 0; i < height; i++) {
    DMA[3].src = &lcolor;
    DMA[3].dst = videoBuffer + OFFSET(row+i, col, WIDTH); // not sure whether this is right
...
/*
  ...
  draws an image of custom dimensions that you provide anywhere on the screen, based off the row/col that you provide
*/
